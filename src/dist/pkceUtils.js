 ...
 */
function generateCodeChallenge(codeVerifier, hashingFn) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        if (!((_a = window.crypto.subtle) === null || _a === void 0 ? void 0 : _a.digest) && !hashingFn) {
        ...
        const hashFn = ((_b = window.crypto.subtle) === null || _b === void 0 ? void 0 : _b.digest) || hashingFn;
        const encoder = new TextEncoder();
        const bytes = encoder.encode(codeVerifier); // Encode the verifier to a byteArray
        const hash = yield hashFn('SHA-256', bytes); // sha256 hash it
